...
router.post('/user',(req,res)=>{
    ...
    if(!name||!age||!email||!startDate||!feesPaid||!batchNumber||name==""||email==""||startDate=="NaN/undefined/"||batchNumber==0){
        ...
        .then((savedUser)=>{
              ...
              if(savedUser){
                    ...
                    if(Days_difference>30){
                        ...
                        .then((updatedUser)=>{
                             res.status(200).json({"message":"successful","data":updatedUser,"message_id":"1"})
                             return ;
                        }).catch((err)=>{
              ...
              //Else store information of user
                    ...
                    .then((data)=>{
                        ...
                        res.status(401).json({"message":"successful","data":data,"message_id":"3"})
                        return ;
                    }).catch((err)=>{
